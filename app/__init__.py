...
def create_app(config_name='development'):
    ...
    def init_site_config():
        ...
        if SiteConfig.objects.count() == 0:
            ...
            config_items = [
                ...
                {'key': 'icp_text', 'value': '', 'description': '备案信息文本', 'type': 'str'},
                {'key': 'icp_link', 'value': '', 'description': '备案信息链接地址', 'type': 'str'},
            ]
    ...
    file_handler = RotatingFileHandler(
        os.path.join(logs_dir, 'app.log'), maxBytes=10240, backupCount=10, encoding='utf-8'
    )
